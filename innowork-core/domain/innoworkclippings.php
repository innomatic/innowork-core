...
// ----- Rendering -----
//
$gWui->addChild(new WuiInnomaticPage('page', array('pagetitle' => $gPage_title, 'icon' => 'folder_txt', 'menu' => $gInnowork_core->GetMainMenu(), 'toolbars' => array(new WuiInnomaticToolBar('core', array('toolbars' => $gCore_toolbars)), new WuiInnomaticToolbar('view', array('toolbars' => $gToolbars))), 'maincontent' => new WuiXml('page', array('definition' => $gXml_def)), 'status' => $gPage_status)));
